...
describe(`${pkg.name}/mars-rover`, () => {
  ...
  describe('#move', () => {
    ...
    it('does not move if is blocked by an obstacle', () => {
    ...
    describe('backwards', () => {
      ...
      it('does not move if is blocked by an obstacle, heading EAST', () => {
      ...
      it('does not move if is blocked by an obstacle, heading NORTH', () => {
      ...
      it('does not move if is blocked by an obstacle, heading SOUTH', () => {
      ...
      it('does not move if is blocked by an obstacle, heading WEST', () => {
